// convert_h5ad_to_parquet build_main
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "name" : "--output_train",
          "example" : [
            "resources/datasets/neurips-2023-data/de_train.parquet"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
        ...
        },
        {
          ...
          "name" : "--output_test",
          "example" : [
            "resources/datasets/neurips-2023-data/de_test.parquet"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
  ...
  "build_info" : {
    ...
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/process_dataset/convert_h5ad_to_parquet",
    "viash_version" : "0.9.0",
