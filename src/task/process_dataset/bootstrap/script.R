...
par <- list(
  ...
  bootstrap_obs_fraction = NULL,
  bootstrap_var_fraction = NULL
)
## VIASH END
...
bootstrap_obs_fraction <- par$bootstrap_obs_fraction %||% 1
bootstrap_var_fraction <- par$bootstrap_var_fraction %||% 1
